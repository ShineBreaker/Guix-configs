...
;;; ============================================================
;;; §8  指令清单（`blue list` 展示用）
;;; =================================================;;=========
;;;
;;; 这张表只服务于自写的 list 命令——它把所有指令（含 blue 内建的 build/
;;; check/clean）按分类展示，并配一句话说明。改了命令的 synopsis/help
;;; 之后，记得同步这里好让 `blue list` 输出保持准确。
...
;; 打印整张表（自写 list 命令的主体）。列宽按各分类内最长指令名对齐。
