...
function openDetail(id) {
  ...
  var html =
    ...
    esc(c.file || "") +
    "</div>" +
    '<div class="field"><span class="k">状态</span><span class="status-badge status-' +
    esc(c.status || "done") +
    '">' +
    esc(c.status || "?") +
    "</span></div>" +
    '<div class="field"><span class="k">类别</span><span class="v">' +
    esc(c.category || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">类型</span><span class="v">' +
    esc(c.type || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">作者</span><span class="v">' +
    esc(c.owner || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">创建</span><span class="v">' +
    esc(c.created || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">最近使用</span><span class="v">' +
    esc(c.last_used || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">最近验证</span><span class="v">' +
    esc(c.last_verified || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">tech</span><span class="v">' +
    esc(c.tech || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">entry_type</span><span class="v">' +
    esc(c.entry_type || "—") +
    "</span></div>" +
    '<div class="field"><span class="k">tags</span>' +
    (c.tags || [])
      .map(function (t) {
    ...
    (staleDays > 180
      ? '<div class="stale-warn">⚠ 已超过 180 天未使用</div>'
      : staleDays > 60
        ? '<div class="stale-warn">⚠ 已超过 60 天未使用</div>'
        : "");
