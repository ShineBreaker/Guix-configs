...
10. **提交变更** — `kb commit -m "策展: <一句话总结>"`
    ...
    - 控制在 50 字以内
    - 示例：`策展: 新增 2 张 guix 经验，更新 1 张，新增 1 条 feedback`
    - 无变更时跳过此步骤
...
- **模式失效** — 已有 feedback 被 ≥2 张新卡片推翻
- **反馈冲突** — 用户反馈中的偏好与近期卡片记录严重不一致
...
| 经验覆盖率       | ≥30% 的经验有对应 feedback | 推动反馈归纳               |
| 过时卡片比例     | <10%                       | 归档或更新                 |
